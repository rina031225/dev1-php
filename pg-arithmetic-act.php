    ...
    <form action="" method="POST">
        ...
        <?php
            ...
            if(isset($_POST['submit'])){
                ...
                echo 
                    "<div class='mt-5 bg-success text-white'>Sum: $sum</div>
                    <div class='bg-success text-white'>Difference: $difference</div>
                    <div class='bg-success text-white'>Product: $product</div>
                    <div class='bg-success text-white'>Quotient: $quotient</div>
                    ";
