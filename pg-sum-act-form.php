    ...
    <div class="container mt-5 w-50">
        ...
        <?php
            ...
            if(isset($_POST['submit'])){
                ...
                $sumOFNumbers = add($number1, $number2);//add($number1, $number2);
                echo "<div class='mt-5 bg-success text-white p-3'>sum: $sumOFNumbers</div>";
                //output
            ...
            // function displayResult($sumOFNumbers){
            //     echo "$sumOFNumbers";
            // }
